$(document).ready(function(){
    ...
    var bg_img = new Array(<?php echo base_url('images/1.jpg');?>,<?php echo base_url('images/2.jpg');?>,<?php echo base_url('images/3.jpg');?>,<?php echo base_url('images/4.png');?>);
    for (var i=0; i < bg_img.length; i++) {
        imgTemplate = "<img src="<?php echo base_url(' + bg_img[i] + ');?>" alt="image" >";
