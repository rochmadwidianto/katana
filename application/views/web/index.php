                    ...
                    <div class="container-fluid" id="wrapper" style="background-color: #1E90FF; padding-bottom:3%" >
                        <div class="row" align="right" style="margin-bottom:-3%; margin-top:0.1%; margin-right:-1%"> <b>LOGIN</b> 
                                                <div class="btn-group" role="group" aria-label="">
                                                    ...
                                                    <a href="<?php echo site_url('web/tambah_katana');?>" rel="popover" title="Karang Taruna anda belum terdaftar?" data-content="Segera daftarkan Karang Taruna anda dan nikmati fitur - fitur KATANA yang dapat membantu anda dalam mengelola segala aktifitas dan data Karang Taruna."><button type="button" 
                                                        class="btn btn-warning"><i class="glyphicon glyphicon-plus"></i> Karang Taruna</button></a>
                                                </div>
                                            </div>
                    </div>
                    <div class="container-fluid" id="wrapper" style="background-color:#00BFFF; padding-bottom:3%" >
                        <div class="container">
                            <div class="row">
                                <div class="col-md-3">
                                </div>
                                <div class="col-md-6" id="wrapper3" style="background-color:#B0C4DE; margin-top: 3%; padding-bottom:8%">
                                    <div class="row">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <img src="<?php echo base_url('assets/img/logo.png');?>" width="80px" height="80px" style="margin-bottom:3%; margin-top:5%"><br><font size="3">LOGIN<br><b>ANGGOTA KARANG TARUNA</b></font><br><font size="2">SISTEM INFORMASI KEGIATAN KARANG TARUNA</font>
                                            </div>
                                            <div class="row" align="center" style="margin-top:5%;">
                                            <form class="form-horizontal" align="center" role="form" action="<?php echo site_url('web/loganggota');?>" method="post">
