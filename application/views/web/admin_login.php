                                ...
                                <div class="col-md-6" id="wrapper3" style="background-color:#B0C4DE; margin-top: 3%; padding-bottom:8%">
                                    <div class="row" style="margin-bottom:4.6%">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <img src="<?php echo base_url('assets/img/logo.png');?>" width="80px" height="80px" style="margin-bottom:3%; margin-top:5%"><br><font size="3">LOGIN<br><b>ADMIN KARANG TARUNA</b></font><br><font size="2">SISTEM INFORMASI KEGIATAN KARANG TARUNA</font>
                                            </div>
                                            <div class="row" align="center" style="margin-TOP:5%;">
                                            <form class="form-horizontal" align="center" role="form" action="<?php echo site_url('web/logadmin');?>" method="post">
