...
<div class="row" style="margin-bottom:2%">
  ...
  <ul class="dropdown-menu" role="menu">
    ...
    <div class="col-md-5">
<form class="navbar-form navbar-right" role="search" action="<?php echo site_url('superadmin/cariKegSemua');?>" method="post">
                    <div class="form-group">
                        <input type="text" name="cari" class="form-control" placeholder="Masukkan nama kegiatan">
                            </div>
                      <button type="submit" href="<?php echo site_url('superadmin/cariKegSemua');?>" class="btn btn-primary"><i class="glyphicon glyphicon-search"></i> Cari</button>
                </form>
    </div>
