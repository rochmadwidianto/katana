  <ol id="wrapper" class="breadcrumb" style="padding-top:1%; padding-bottom:1%; margin-bottom:2%">
    ...
    <li class="active"><i class="glyphicon glyphicon-search"></i>  Pencarian Anggota</li>
  </ol>
            ...
            <div class="panel-body">
              ...
              <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td align="center"><a href="<?php echo site_url('dashboard/detail_anggota/'.$row->idAgg);?>" rel="tooltip" title="Tampilkan detail data anggota"><i class="glyphicon glyphicon-tag"></i></a></td>
                </tr>
                <?php endforeach;?>
            </Table>
